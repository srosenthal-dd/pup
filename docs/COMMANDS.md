...
| apm | services (list, stats, operations, resources), entities (list), dependencies (list), flow-map, troubleshooting (list), service-library-config (get) | src/commands/apm.rs | ✅ |
